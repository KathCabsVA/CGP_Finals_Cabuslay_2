    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (VertexOutput i) : SV_Target
            {
                ...
                // Using step function
                float edge = 0.5;
                float stepLightFallOff = step(edge, LightFallOff);

                // Using smoothstep function
                float smoothLightFallOff = smoothstep(0.3, 0.7, LightFallOff);

                float3 DirectDiffuseLight = LightColor * smoothLightFallOff;
